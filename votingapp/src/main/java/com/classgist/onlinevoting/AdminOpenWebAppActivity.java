...
public class AdminOpenWebAppActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.adminopenwebapp);
        web = (WebView) findViewById(R.id.webview01);

        wpBtn = (Button) findViewById(R.id.wp_btn);
        ...
        wpBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(AdminOpenWebAppActivity.this, HomeScreen.class);
